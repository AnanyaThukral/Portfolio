...
const Next = () => {
    return (
        <Container>
            ...
            <TextContainer>
                <Text>The vision of this idea is to have a <Bold>Advisor Dashboard</Bold> as well along with a <Bold>Student Dashboard</Bold>. The reason being that a concern raised by the international advisors while sharing the idea with them that as we are dealing with immigration that could potentially result in sharing lot of confidential information between students.</Text> 
