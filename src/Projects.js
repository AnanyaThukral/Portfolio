    ...
    return (
        <Container>
            ...
            <ProjectContainer>
                ...
                <Project onClick = {()=> history.push('/WebClones')} image = "./img/Slack.png" title = "Web Clones" text = "Amazon, Slack, LinkedIn Key features Integrated" color = "radial-gradient(#fbc1cc, #fa99b2)" tags = {["UI Design", "React JS", "Firebase Auth", "Firebase Database"]}/>  
